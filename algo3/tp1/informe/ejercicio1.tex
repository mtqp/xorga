...
{\footnotesize [2] Por propiedades del módulo $x*y\; mod \; z = (x\; mod\; z)*(y\; mod\; z)$ } \\
	...
	\begin{subsection}{Pruebas y Resultados}
		...
		En este otro gráfico se observa de forma muy parecida a la función que dada una instancia devuelve el tiempo transcurridos durante la ejecución del algoritmo. También se ve acotada por la función logaritmo con parametro $n$. Al no ser una herramienta muy precisa el contar los ciclos de reloj, se pueden ver algunos outlayers por encima de la curva del logaritmo. Aun así, los resultados coninciden con las predicciones en cuanto a la complejidad.
	\end{subsection}
