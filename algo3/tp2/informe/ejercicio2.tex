\begin{section}{Problema 2}
	...
	\gra{ciudad/count_test_mejor_caso.pdf}
		...
		Queremos observar que no tomamos en cuenta el costo de la inicialización de la matriz de adyacencia (su costo es \Ode{n^2}), de esta forma podemos afirmar que nuestro mejor caso para la función ciudad es lineal (la complejidad se analizó sólo sobre la función principal -ciudad-).
