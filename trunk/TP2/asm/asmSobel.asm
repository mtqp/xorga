...
section .data
	...
	sobel_Y_linea1: DW -1,-2,-1,-1,-2,-1,-1,-2
	sobel_Y_linea3: DW 1,2,1,1,2,1,1,2
...
derivada_y:
	lea edx, [esi+ecx]
	aplicarLineaX edx, sobel_Y_linea1	; calcula en xmm6:xmm7 la primer línea
	add edx, width
	add edx, width
	aplicarLineaX edx, sobel_Y_linea3
