...
\begin{section}{Heurística constructiva}
		\begin{subsection}{Explicación}
			...
			Continúa eligiendo los de menor grado que sean adyacentes a todos los vértices de la solución parcial, que en la figura se muestra en los sucesivos gráficos del grafo.
		...
		\begin{subsection}{Desventajas }
			...
			CHER CARLINGUA AGREGALE POR LOMENOS UN NODO AL 5, XQ SINO ESTA MAL TODO EL GRAFICO DEL MUNDO ROCK.TQP();
			...
			Este grafo en particular la clique máxima es de $cuatro$ vértices, y el algoritmo constructivo no la encuentra. Esto sucede por que los grados de la clique resultante son los mayores de todo el grafo, y además, está condicionado a comenzar con el vértice $cinco$. Es entonces que en los casos donde el de grado máximo posee una cantidad significativa de nodos colgando, y/o circuitos, y/o caminos, el algoritmo tenderá a obtener una solución lejos de la óptima. Si en cambio, el de mayor grado se encuentra conectado a la clique máxima, muy probablemente la solución sea la óptima.
		\end{subsection}
