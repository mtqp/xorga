...
\newpage
	...
	\begin{section}{Mediciones}
		\begin{itemize}
			\item Para contar la cantidad aproximada de operaciones definimos una variable inicializada en $cero$ la cual incrementamos luego de cada operación. En el código puede verse como la llamada a la función \texttt{O(x)}, donde $x$ es un valor positivo entero, el cual es sumado a la cantidad de operaciones parcial para una vez terminado el algortimo, poseer la cantidad de operaciones que realiza para una instancia dada.
