\begin{section}{Tabu-Search}
	...
	Una vez que fijamos el valor del parámetro notamos que debia tener una cota inferior, dado que si el valor era demasiado chico el algoritmo funciona muy mal, es decir, el tamaño de la clique que encuentra esta muy lejos del óptimo. En otras palabras, si el valor del parámetro 'tiende' a $uno$ el resultado de la heurística de búsqueda tabú es muy similar al de la búsqueda local. Por este motivo, el valor parámetro termina siendo el máximo entre el $40$ por ciento del tamaño de la clique inicial y $tres$. Elegimos el valor $tres$ pensando en que recien iniciando desde una clique de $tres$ vértices nos interesa remarcar la diferencia en el comportamiento con la búsqueda local y poder así sacar varios vértices a la vez.
	\end{subsection}
\end{section}
