\begin{section}{Tabu-Search}
	...
	En el gráfico (Figura \ref{fig:Ajuste_del_parametro_iteraciones2}) observamos que para el valor $100$ del parámetro para grafos grandes el tiempo de ejecución es considerable. Por este motivo, directamente no graficamos los tiempos para los valores $200$ y $300$.
	\end{subsection}
\end{section}
