		...
		for(int i=0;i<n;i++){
			if(actual[i]){		//saco un nodo perteneciente a la solución actual
				...
				for(int k=0;k<n && agregue;k++){
					...
					//cout << "Actual antes: " << endl;
					//print_vector(actual,n);
					//cout << "Mejor vecindad: " << endl;
					//print_vector(mejor_vecindad,n);
					//cout << "tam_actual " << tam_actual << "tam_mejor_vecindad " << tam_mejor_vecindad << endl;
