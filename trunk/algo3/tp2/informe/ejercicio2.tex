\begin{section}{Problema 2}
	...
	\begin{subsection}{Análisis de complejidad}
		...
		La función $adyacente\_externo$ tiene un costo del orden de $n^2$ porque recorre todos los vértices y para cada uno de estos que pertenece al circuito busca entre todos los vértices alguno que sea adyacente a él y no pertenezca al circuito (no termina apenas encuentre uno, sino que ).
