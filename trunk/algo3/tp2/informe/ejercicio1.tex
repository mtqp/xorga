\begin{section}{Problema 1}
	...
	\begin{subsection}{Pruebas y Resultados}
		Para probar correctitud tenemos un generador de secuencias unimodales, secuencias crecientes y decrecientes que nos devuelve en un archivo $test\_*.in$, donde $*$ se refiere a $unimodal,\; creciente\; o\; decreciente$ según corresponda. Para cada uno de ellos, existirá también el archivo $test\_secuencia.out$ con la salida esperada (todo en $cero$ porque son todas unimodales, ya que la creciente y la decreciente son un caso particular de secuencias unimodales). De esta forma, con una comparación de archivos (comando \texttt{make diffs} ) podemos saber para cada instancia si el resultado obtenido por nuestro algoritmo se condice con el resultado correspondiente a esa instancia en el archivo \texttt{test\_secuencia.out}.\\
