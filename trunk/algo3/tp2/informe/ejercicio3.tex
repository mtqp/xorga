\begin{section}{Problema 3}
	...
	\begin{subsection}{Detalles de la implementación}
		...
		También tenemos un arreglo de bools llamado $enEspera$ el cual esta inicicalizado en falso si el vértice $i$ no puede ser accedido (tiene puerta), y en verdadero en caso contrario. Entonces, para cada vértice, de existir una posible restriccion de acceso, su posición permanece en falso.\\
