...
;	mask_borrar_px1: DQ 0x0000ffff00000000, 0xffff000000000000
	mask_borrar_px1: DQ 0x00000000ffff0000, 0x000000000000ffff
;	mask_borrar_px2: DQ 0X00000000ffff0000, 0x0000ffff00000000
	mask_borrar_px2: DQ 0x0000ffff00000000, 0x00000000ffff0000
;	mask_borrar_px3: DQ 0x000000000000ffff, 0x00000000ffff0000
...
section .text
	global pm			;debo pasar *src y *dst
...
;	mov ecx,0			;if (ecx==1) then processH else processL
...
;creo q no es necesario!!!	pxor xmm3,xmm3
...
bor:			;en xmm1 estan las ocho words altas
	movdqu xmm0,xmm2
...
;	inc ecx				;para el cmp y no haga los pixels borde
;	jmp procesar_matrices
